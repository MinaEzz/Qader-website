...
const ProductFeedback = () => {
  return (
    <section className="w-full bg-white rounded-xl p-4 flex flex-col gap-4">
      <h4 className="text-slate-700 text-xl font-bold capitalize">feedback</h4>
      <div className="w-full flex flex-col gap-8 ">
        <p className="text-sm text-slate-700 py-2 border-b border-neutral-400 ">
